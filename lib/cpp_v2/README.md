Thrift C++ Software Library (Version 2)
...
* libthrift2 - The core Thrift library contains all the core Thrift code. It requires
  boost shared pointers, pthreads, and librt.

* libthriftnb2 - This library contains the Thrift nonblocking server, which uses libevent.
