...
public:
  ...
  TPipeServerImpl(const TPipeServerImpl&) = delete;
  TPipeServerImpl& operator=(const TPipeServerImpl&) = delete;
...
public:
  ...
  virtual shared_ptr<TTransport> acceptImpl();
...
private:
  ...
  shared_ptr<TPipe> cached_client_;
  TAutoHandle Pipe_;
