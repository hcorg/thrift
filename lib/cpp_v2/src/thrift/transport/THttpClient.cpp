...
THttpClient::THttpClient(shared_ptr<TTransport> transport, string host, string path)
  : THttpTransport(transport), host_(host), path_(path) {
}

THttpClient::THttpClient(string host, int port, string path)
  : THttpTransport(shared_ptr<TTransport>(new TSocket(host, port))), host_(host), path_(path) {
}
