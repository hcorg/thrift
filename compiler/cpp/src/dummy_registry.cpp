...
#define THRIFT_GENERATOR_REFERENCE(language)                                                       \
  ...
  void* dummy_##language##_registry_function() { return &global_##language##_registerer; }
...
THRIFT_GENERATOR_REFERENCE(cpp_v1)
...
THRIFT_GENERATOR_REFERENCE(haxe)
...
THRIFT_GENERATOR_REFERENCE(json)
...
THRIFT_GENERATOR_REFERENCE(cpp_v2)
#endif
