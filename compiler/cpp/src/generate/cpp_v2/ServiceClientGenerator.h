...
#ifndef THRIFT_COMPILER_GENERATE_CPP_V2_SERVICECLIENTGENERATOR_H_
#define THRIFT_COMPILER_GENERATE_CPP_V2_SERVICECLIENTGENERATOR_H_
...
struct ServiceClientGenerator {

  static std::string getFileNameBase(const t_service* service);
  static std::string getClassName(const t_service* service) { return getFileNameBase(service); }
  ...
  private:
    ...
    std::string getParentServiceName() const;
...
#endif // THRIFT_COMPILER_GENERATE_CPP_V2_SERVICECLIENTGENERATOR_H_
