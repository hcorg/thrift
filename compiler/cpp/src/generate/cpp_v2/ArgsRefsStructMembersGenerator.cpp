...
ArgsRefsStructMembersGenerator::ArgsRefsStructMembersGenerator(OutputGenerator& parent,
                                                               const t_struct* tStruct)
  : ArgsStructMembersGenerator(parent, tStruct) {
}

void ArgsRefsStructMembersGenerator::generateFields() {
  FieldsRefsGenerator gen(*this, getStruct()->get_members(), getCppNamespace(getStruct()));
  gen.generateContents();
}

void ArgsRefsStructMembersGenerator::generateDefinitions() {
  doWith<StructWriteGenerator>(appendDefinition);
  doWith<OperatorOstreamGenerator>(appendDefinition);
}

void ArgsRefsStructMembersGenerator::generateBodyDeclarations() {
