...
#ifndef THRIFT_COMPILER_GENERATE_CPP_V2_SOURCEFILEGENERATOR_H_
#define THRIFT_COMPILER_GENERATE_CPP_V2_SOURCEFILEGENERATOR_H_
...
class SourceFileGenerator : public OutputGenerator {
public:
  SourceFileGenerator(std::ostream& out,
...
#endif // THRIFT_COMPILER_GENERATE_CPP_V2_SOURCEFILEGENERATOR_H_
