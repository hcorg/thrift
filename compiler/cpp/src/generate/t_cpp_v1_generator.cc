...
t_cpp_v1_generator::t_cpp_v1_generator(t_program* program,
...
bool t_cpp_v1_generator::is_reference(t_field* tfield) {
  return tfield->get_reference();
}

bool t_cpp_v1_generator::is_complex_type(t_type* ttype) {
...
void t_cpp_v1_generator::set_use_include_prefix(bool use_include_prefix) {
 ...
 * streams.
 */
void t_cpp_v1_generator::init_generator() {
 ...
 */
void t_cpp_v1_generator::close_generator() {
  // Close namespace
 ...
 */
void t_cpp_v1_generator::generate_typedef(t_typedef* ttypedef) {
  f_types_ << indent() << "typedef " << type_name(ttypedef->get_type(), true) << " "
           << ttypedef->get_symbolic() << ";" << endl << endl;
}

void t_cpp_v1_generator::generate_enum_constant_list(std::ofstream& f,
 ...
 */
void t_cpp_v1_generator::generate_enum(t_enum* tenum) {
 ...
 */
void t_cpp_v1_generator::generate_consts(std::vector<t_const*> consts) {
 ...
 */
void t_cpp_v1_generator::print_const_value(ofstream& out,
                                           string name,
                                           t_type* type,
                                           t_const_value* value) {
 ...
 *
 */
string t_cpp_v1_generator::render_const_value(ofstream& out,
                                              string name,
                                              t_type* type,
                                              t_const_value* value) {
  (void)name;
...
void t_cpp_v1_generator::generate_forward_declaration(t_struct* tstruct) {
 ...
 */
void t_cpp_v1_generator::generate_cpp_struct(t_struct* tstruct, bool is_exception) {
...
void t_cpp_v1_generator::generate_copy_constructor(ofstream& out,
                                                   t_struct* tstruct,
                                                   bool is_exception) {
...
void t_cpp_v1_generator::generate_assignment_operator(ofstream& out, t_struct* tstruct) {
  std::string tmp_name = tmp("other");
 ...
 */
void t_cpp_v1_generator::generate_struct_declaration(ofstream& out,
                                                     t_struct* tstruct,
                                                     bool is_exception,
                                                     bool pointers,
                                                     bool read,
...
void t_cpp_v1_generator::generate_struct_definition(ofstream& out,
 ...
 * @param tstruct The struct
 */
void t_cpp_v1_generator::generate_struct_fingerprint(ofstream& out,
                                                     t_struct* tstruct,
                                                     bool is_definition) {
 ...
 */
void t_cpp_v1_generator::generate_local_reflection(std::ofstream& out,
                                                   t_type* ttype,
                                                   bool is_definition) {
  if (!gen_dense_) {
    return;
 ...
 */
void t_cpp_v1_generator::generate_local_reflection_pointer(std::ofstream& out, t_type* ttype) {
  if (!gen_dense_) {
    return;
  }
 ...
 * @param tstruct The struct
 */
void t_cpp_v1_generator::generate_struct_reader(ofstream& out, t_struct* tstruct, bool pointers) {
  if (gen_templates_) {
 ...
 * @param tstruct The struct
 */
void t_cpp_v1_generator::generate_struct_writer(ofstream& out, t_struct* tstruct, bool pointers) {
 ...
 */
void t_cpp_v1_generator::generate_struct_result_writer(ofstream& out,
                                                       t_struct* tstruct,
                                                       bool pointers) {
  string name = tstruct->get_name();
  const vector<t_field*>& fields = tstruct->get_sorted_members();
 ...
 * @param tstruct The struct
 */
void t_cpp_v1_generator::generate_struct_swap(ofstream& out, t_struct* tstruct) {
  out << indent() << "void swap(" << tstruct->get_name() << " &a, " << tstruct->get_name()
      << " &b) {" << endl;
  indent_up();
...
class StructOstreamOperatorGenerator : public apache::thrift::compiler::generate::OutputGenerator {
public:
  StructOstreamOperatorGenerator(std::ofstream& out)
    : apache::thrift::compiler::generate::OutputGenerator(out), tstruct_(NULL) {}

  void generate_declaration(t_struct* tstruct) {
    out() << "std::ostream& operator<<(std::ostream& out, const " << tstruct->get_name()
          << "& obj)";
  }
...
private:
  void generate_body() {
    apache::thrift::compiler::generate::ScopeGuard guard(*this);
    generate_header();
  ...
  void generate_field_name(const t_field* field) { out() << "\"" << field->get_name() << "=\""; }
...
void t_cpp_v1_generator::generate_struct_ostream_operator_decl(std::ofstream& out,
                                                               t_struct* tstruct) {
 ...
 * Generates operator<<
 */
void t_cpp_v1_generator::generate_struct_ostream_operator(std::ofstream& out, t_struct* tstruct) {
  StructOstreamOperatorGenerator generator(out);
  generator.setIndent(getIndent());
 ...
 */
void t_cpp_v1_generator::generate_service(t_service* tservice) {
 ...
 */
void t_cpp_v1_generator::generate_service_helpers(t_service* tservice) {
 ...
 * @param tservice The service to generate a header definition for
 */
void t_cpp_v1_generator::generate_service_interface(t_service* tservice, string style) {
 ...
 */
void t_cpp_v1_generator::generate_service_interface_factory(t_service* tservice, string style) {
  string service_if_name = service_name_ + style + "If";
 ...
 * @param tservice The service to generate a header definition for
 */
void t_cpp_v1_generator::generate_service_null(t_service* tservice, string style) {
  string extends = "";
  if (tservice->get_extends() != NULL) {
...
void t_cpp_v1_generator::generate_function_call(ostream& out,
...
void t_cpp_v1_generator::generate_service_async_skeleton(t_service* tservice) {
  string svcname = tservice->get_name();
 ...
 */
void t_cpp_v1_generator::generate_service_multiface(t_service* tservice) {
 ...
 */
void t_cpp_v1_generator::generate_service_client(t_service* tservice, string style) {
  string ifstyle;
  if (style == "Cob") {
    ifstyle = "CobCl";
  }
...
public:
  ProcessorGenerator(t_cpp_v1_generator* generator, t_service* service, const string& style);
...
ProcessorGenerator::ProcessorGenerator(t_cpp_v1_generator* generator,
                                       t_service* service,
                                       const string& style)
 ...
 */
void t_cpp_v1_generator::generate_service_processor(t_service* tservice, string style) {
 ...
 */
void t_cpp_v1_generator::generate_function_helpers(t_service* tservice, t_function* tfunction) {
 ...
 */
void t_cpp_v1_generator::generate_process_function(t_service* tservice,
                                                   t_function* tfunction,
                                                   string style,
                                                   bool specialized) {
 ...
 * @param tservice The service to generate a server for.
 */
void t_cpp_v1_generator::generate_service_skeleton(t_service* tservice) {
  string svcname = tservice->get_name();
 ...
 */
void t_cpp_v1_generator::generate_deserialize_field(ofstream& out,
                                                    t_field* tfield,
                                                    string prefix,
                                                    string suffix) {
 ...
 */
void t_cpp_v1_generator::generate_deserialize_struct(ofstream& out,
                                                     t_struct* tstruct,
                                                     string prefix,
                                                     bool pointer) {
  if (pointer) {
...
void t_cpp_v1_generator::generate_deserialize_container(ofstream& out,
                                                        t_type* ttype,
                                                        string prefix) {
  scope_up(out);
 ...
 */
void t_cpp_v1_generator::generate_deserialize_map_element(ofstream& out,
                                                          t_map* tmap,
                                                          string prefix) {
  string key = tmp("_key");
  string val = tmp("_val");
...
void t_cpp_v1_generator::generate_deserialize_set_element(ofstream& out,
                                                          t_set* tset,
                                                          string prefix) {
...
void t_cpp_v1_generator::generate_deserialize_list_element(ofstream& out,
                                                           t_list* tlist,
                                                           string prefix,
                                                           bool use_push,
                                                           string index) {
 ...
 */
void t_cpp_v1_generator::generate_serialize_field(ofstream& out,
                                                  t_field* tfield,
                                                  string prefix,
                                                  string suffix) {
  t_type* type = get_true_type(tfield->get_type());
 ...
 */
void t_cpp_v1_generator::generate_serialize_struct(ofstream& out,
                                                   t_struct* tstruct,
                                                   string prefix,
                                                   bool pointer) {
  if (pointer) {
...
void t_cpp_v1_generator::generate_serialize_container(ofstream& out, t_type* ttype, string prefix) {
  scope_up(out);
 ...
 *
 */
void t_cpp_v1_generator::generate_serialize_map_element(ofstream& out, t_map* tmap, string iter) {
 ...
 */
void t_cpp_v1_generator::generate_serialize_set_element(ofstream& out, t_set* tset, string iter) {
 ...
 */
void t_cpp_v1_generator::generate_serialize_list_element(ofstream& out,
                                                         t_list* tlist,
                                                         string iter) {
 ...
 * @return Namespaces
 */
string t_cpp_v1_generator::namespace_prefix(string ns) {
 ...
 * @return Namespaces
 */
string t_cpp_v1_generator::namespace_open(string ns) {
  if (ns.size() == 0) {
    return "";
  }
  string result = "";
 ...
 * @return Namespaces
 */
string t_cpp_v1_generator::namespace_close(string ns) {
  if (ns.size() == 0) {
    return "";
  }
  string result = "}";
 ...
 */
string t_cpp_v1_generator::type_name(t_type* ttype, bool in_typedef, bool arg) {
 ...
 */
string t_cpp_v1_generator::base_type_name(t_base_type::t_base tbase) {
  switch (tbase) {
  case t_base_type::TYPE_VOID:
    return "void";
  case t_base_type::TYPE_STRING:
 ...
 */
string t_cpp_v1_generator::declare_field(t_field* tfield,
                                         bool init,
                                         bool pointer,
                                         bool constant,
                                         bool reference) {
 ...
 */
string t_cpp_v1_generator::function_signature(t_function* tfunction,
                                              string style,
                                              string prefix,
                                              bool name_params) {
 ...
 */
string t_cpp_v1_generator::argument_list(t_struct* tstruct, bool name_params, bool start_comma) {
  string result = "";
 ...
 */
string t_cpp_v1_generator::type_to_enum(t_type* type) {
  type = get_true_type(type);
 ...
 */
string t_cpp_v1_generator::local_reflection_name(const char* prefix, t_type* ttype, bool external) {
  ttype = get_true_type(ttype);
...
string t_cpp_v1_generator::get_include_prefix(const t_program& program) const {
...
THRIFT_REGISTER_GENERATOR(
    cpp_v1,
    "C++ Version 1",
    "   Generates files compatible with Version 1 of Thrift C++ library\n"
